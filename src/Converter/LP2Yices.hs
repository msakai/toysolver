...
convert :: LP.LP -> Bool -> Bool -> ShowS
convert lp optimize check =
...
testFile fname = do
  ...
  case result of
    Right lp -> putStrLn $ convert lp True True ""
    Left err -> hPrint stderr err

test :: IO ()
test = putStrLn $ convert testdata True True ""
