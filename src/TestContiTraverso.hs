...
-- optimum is (3,2,0)
case_ikegami = solve grlex cs obj @?= Just (IM.fromList [(1,3),(2,2),(3,0)])
  where
...
disabled_case_test1 = solve grlex cs obj @?= Just (IM.fromList [(1,39), (2,75), (3,1), (4,8), (5,122)])
  where
...
-- optimum is (0,2,2)
case_test2 = solve grlex cs obj @?= Just (IM.fromList [(1,0),(2,2),(3,2)])
  where
...
-- infeasible
case_test3 = solve grlex cs obj  @?= Nothing
  where
    vs@[x1,x2,x3] = map LA.var [1..3]
